...
export default function Post({ date, title, tags, postId, intro, image }) {
    ...
    return (
        <Suspense>
            <>
                <div className={`${popupClass} text-lg bg-primary-color text-white left-1/2 -translate-x-1/2 bottom-8 z-20 p-4 popup border border-black select-none`}>{popupText}</div>
